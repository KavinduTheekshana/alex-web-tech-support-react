  ...
  return (
    <main>
      ...
      <section className="banner__inner-page bg-image pt-180 pb-180" data-background="/assets/images/banner/banner-inner-page.jpg">
        ...
        <div className="container">
          ...
          <div className="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <Link to="/">Home</Link><span><i className="fa-regular fa-angles-right mx-2"></i>Contact Us</span>
          </div>
        </div>
      </section>
          ...
          <div className="row g-4">
            <div className="col-lg-6">
              <div className="contact__left-item primary-bg">
                ...
                <p className="text-white">Get in touch with us through the details below. Whether it's by phone, email, or visiting our office, we're always ready to assist with your IT requirements.</p>
            ...
            <div className="col-lg-6">
              <div className="contact__right-item">
                <div className="section-header mb-20">
                  ...
                  <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Ready to Get Started?</h2>
                </div>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="btn-two">
                      ...
                      <button type="submit" className="btn-one" disabled={isSubmitting}>
                        {isSubmitting ? (
                          <>Sending... <i className="fa-regular fa-spinner fa-spin"></i></>
                        ) : (
      ...
      <div className="contact__map">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1241.2424633509027!2d-0.139447!3d51.522665!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761bb0fc106227%3A0xf98a868cbbea7a06!2sTech%20Support%20Inc!5e0!3m2!1sen!2sus!4v1735091866708!5m2!1sen!2sus"
          width="600"
          height="450"
          style={{border:0}}
          allowFullScreen=""
          ...
          title="Tech Support Inc Location"
        ></iframe>
      </div>
