...
const Home = () => {
  useEffect(() => {
    ...
    // 2. Initialize Banner Slider with animations (CRITICAL for data-animation attributes)
    let sliderInit1 = null;
    if (window.Swiper) {
      const sliderActive1 = ".banner__slider";
      sliderInit1 = new window.Swiper(sliderActive1, {
        loop: true,
        slidesPerView: 1,
        effect: "fade",
        speed: 3000,
      ...
      // THIS IS THE KEY PART - Animated Swiper function for data-animation attributes
      function animated_swiper(selector, init) {
        const animated = function() {
          window.jQuery(selector + " [data-animation]").each(function() {
            const anim = window.jQuery(this).data("animation");
            const delay = window.jQuery(this).data("delay");
            const duration = window.jQuery(this).data("duration");
            window.jQuery(this)
              ...
              .one("animationend", function() {
                window.jQuery(this).removeClass(anim + " animated");
              });
          });
        };
        animated();
        init.on("slideChange", function() {
          window.jQuery(sliderActive1 + " [data-animation]").removeClass("animated");
        });
        init.on("slideChange", animated);
      }

      // Apply the animation function to the slider
      if (window.jQuery) {
        animated_swiper(sliderActive1, sliderInit1);
      }
    }

    // 3. Reinitialize WOW.js for scroll animations
    if (window.WOW) {
    ...
    // 4. Counter animations (with waypoint check)
    if (window.jQuery && window.jQuery.fn.counterUp && window.jQuery.fn.waypoint) {
    ...
    // 5. Initialize Case Studies Slider
    if (window.Swiper) {
      const caseSlider = new window.Swiper(".case__slider", {
        loop: true,
        spaceBetween: 24,
        speed: 800,
        autoplay: {
    ...
    // 6. Service item hover effect (Why Choose Us section)
    if (window.jQuery) {
      window.jQuery(".service__item").hover(
        function() {
          // Remove active class from all items
          window.jQuery(".service__item").removeClass("active");
    ...
    if (window.Swiper) {
      const testimonialSlider = new window.Swiper(".testimonial__slider", {
        loop: true,
        spaceBetween: 30,
        speed: 300,
        autoplay: {
  ...
  return (
    <main>
        ...
        <div className="swiper banner__slider">
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div data-animation="slideInLeft" data-duration="2s" data-delay=".3s" className="banner__shape-left2">
                <img src="/assets/images/banner/banner-regular-left-shape.png" alt="shape" />
              </div>
              <div data-animation="slideInLeft" data-duration="2s" data-delay=".9s" className="banner__shape-left1">
              ...
              <div className="banner__shape-right2" data-animation="slideInRight" data-duration="3s" data-delay=".3s">
                <img src="/assets/images/banner/banner-shape-right-line.png" alt="shape" />
              </div>
              <div className="banner__shape-right1" data-animation="slideInRight" data-duration="2s" data-delay=".3s">
                <img src="/assets/images/banner/banner-shape-right.png" alt="shape" />
              </div>
              <div className="banner__right-line1" data-animation="slideInRight" data-duration="2s" data-delay=".9s">
                <img src="/assets/images/banner/banner-right-line1.png" alt="shape" />
              </div>
              <div className="banner__right-line2" data-animation="slideInRight" data-duration="2s" data-delay=".7s">
                <img src="/assets/images/banner/banner-right-line2.png" alt="shape" />
              </div>
              <div className="banner__right-line3" data-animation="slideInRight" data-duration="2s" data-delay=".5s">
                <img src="/assets/images/banner/banner-right-line3.png" alt="shape" />
              </div>
              <div className="banner__right-line4" data-animation="slideInRight" data-duration="2s" data-delay=".3s">
              ...
              <div className="container">
                <div className="banner__content">
                  <h4 data-animation="slideInRight" data-duration="2s" data-delay=".3s" className="text-white mb-20">
                    ...
                    Reliable IT Support & 24/7 Helpdesk
                  </h4>
                  <h1 data-animation="slideInRight" data-duration="2s" data-delay=".5s" className="text-white">
                    Expert IT Solutions for UK Small Businesses
                  </h1>
                  <p data-animation="slideInRight" data-duration="2s" data-delay=".7s" className="mt-20">
                    Proactive IT support, clear pricing, and round-the-clock helpdesk services to keep your business secure, online, and productive.
                  </p>
                  <div data-animation="slideInRight" data-duration="2s" data-delay=".9s" className="mt-60">
                    <Link to="/outsourced-it-support" className="btn-one">Get IT Support <i className="fa-regular fa-arrow-right-long"></i></Link>
                    <Link to="/pricing" className="btn-one ms-3" style={{background: 'transparent', border: '2px solid white'}}>View Pricing <i className="fa-regular fa-arrow-right-long"></i></Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="swiper-slide">
              ...
              <div className="container">
                <div className="banner__content">
                  ...
                  <p data-animation="slideInRight" data-duration="2s" data-delay=".7s" className="mt-20">
                    Advanced security, backup, and virtualization solutions to protect your data and optimize IT efficiency.
                  </p>
                  <Link data-animation="slideInRight" data-duration="2s" data-delay=".9s" to="/services" className="btn-one mt-60">
            ...
            <div className="swiper-slide">
              ...
              <div className="container">
                <div className="banner__content">
                  ...
                  <p data-animation="slideInRight" data-duration="2s" data-delay=".7s" className="mt-20">
                    Customized IT solutions, from device setup to process automation, designed to meet your business needs.
                  </p>
                  <Link data-animation="slideInRight" data-duration="2s" data-delay=".9s" to="/services" className="btn-one mt-60">
                    Explore More <i className="fa-regular fa-arrow-right-long"></i>
                  </Link>
            ...
            <div className="swiper-slide">
              ...
              <div className="slide-bg" data-background="/assets/images/banner/banner-image4.jpg"></div>
              <div className="container">
                <div className="banner__content">
                  <h4 data-animation="slideInRight" data-duration="2s" data-delay=".3s" className="text-white mb-20">
                    <svg className="me-1" width="40" height="16" viewBox="0 0 40 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p data-animation="slideInRight" data-duration="2s" data-delay=".7s" className="mt-20">
                    Custom websites and applications crafted to enhance user experience and drive business growth.
                  </p>
                  <Link data-animation="slideInRight" data-duration="2s" data-delay=".9s" to="/services" className="btn-one mt-60">
                    Explore More <i className="fa-regular fa-arrow-right-long"></i>
                  </Link>
      ...
      {/* Note: Due to space constraints, I'm showing the structure.
          You need to add the remaining sections from the PHP file:
          - Service Section (Why Choose Us)
          - About Section
          - Counter Section
          - Case Studies Section
          - Offer Section (Technology Platforms)
          - Process Section
          - Testimonial Section

          Each section should follow the same pattern as the banner -
          copy the HTML structure from index.php and convert to JSX.
      */}

      {/* Service Section - Why Choose Us */}
      <section className="service-area pt-120 pb-120">
        <div className="service__shape wow slideInRight" data-wow-duration="1500ms">
        ...
        <div className="container">
          <div className="section-header text-center mb-60">
            <h5 className="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
              ...
              <svg className="ms-1" width="20" height="12" viewBox="0 0 20 12" fill="none">
                <rect x="0.75" y="0.75" width="18.5" height="10.5" rx="5.25" fill="#3C72FC"/>
              </svg>
            </h5>
            <h2 className="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Why Choose Us for IT Solutions</h2>
          </div>
          <div className="row g-4">
            <div className="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
              <div className="service__item">
                ...
                <h4><Link to="/about">Personalized IT Solutions</Link></h4>
                <p>We provide customized IT services designed specifically for small businesses, ensuring your unique needs are met.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
              <div className="service__item active">
                <div className="service-shape"><img src="/assets/images/shape/service-item-shape.png" alt="shape" /></div>
                <div className="service__icon">
                  <img src="/assets/images/icon/service-icon2.png" alt="icon" />
                </div>
                <h4><Link to="/about">Expertise and Experience</Link></h4>
                <p>With years of industry experience, our team delivers reliable IT support and innovative solutions you can trust.</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
              <div className="service__item">
                ...
                <h4><Link to="/about">Web Development</Link></h4>
                <p>Professional web solutions that enhance your online presence and drive business growth through user-friendly design.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="offer-area secondary-bg pt-120 pb-200">
        ...
        <div className="container">
          ...
          <div className="row g-4">
            ...
            {/* Platform 2: Android */}
            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
              <div className="offer__item">
                <div className="shape-top">
                  <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape" />
                </div>
            ...
            {/* Platform 3: IOS */}
            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="offer__item">
                <div className="shape-top">
                  <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape" />
                </div>
            ...
            {/* Platform 4: Watch */}
            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
              <div className="offer__item">
                <div className="shape-top">
                  <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape" />
                </div>
            ...
            {/* Platform 5: TV */}
            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div className="offer__item">
                <div className="shape-top">
                  <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape" />
                </div>
            ...
            {/* Platform 6: IOT */}
            <div className="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
              <div className="offer__item">
                <div className="shape-top">
                  <img src="/assets/images/shape/offter-item-shape-top.png" alt="shape" />
                </div>
      ...
      {/* Technology Platforms / Offer Section end */}
            ...
            <div className="swiper-wrapper">
                ...
                <div className="testimonial__item">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div className="testi-info">
                      ...
                      <p>Managing Director, Thompson Legal</p>
                      <div className="star mt-1">
                        <i className="fa-sharp fa-solid fa-star"></i>
                        <i className="fa-sharp fa-solid fa-star"></i>
                        <i className="fa-sharp fa-solid fa-star"></i>
                  ...
                  <p className="mt-30">"Switching to Tech Support Inc was the best decision we made. Clear pricing, no hidden fees, and their Microsoft 365 setup has revolutionized how our team collaborates."</p>
                </div>
              </div>
                ...
                <div className="testimonial__item">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div className="testi-info">
                      ...
                      <p>Finance Manager, Apex Accounting</p>
                      <div className="star mt-1">
                        <i className="fa-sharp fa-solid fa-star"></i>
                        <i className="fa-sharp fa-solid fa-star"></i>
                        <i className="fa-sharp fa-solid fa-star"></i>
                  ...
                  <p className="mt-30">"The proactive monitoring and support have saved us countless hours. When issues do arise, they're resolved quickly. It's like having an in-house IT team without the overhead."</p>
                </div>
              </div>
              ...
              <div className="swiper-slide">
                <div className="testimonial__item">
                  ...
                  <p className="mt-30">"We've been with Tech Support Inc for over 2 years. Their cybersecurity expertise gives us peace of mind, and the pricing calculator helped us budget accurately from day one."</p>
                </div>
              </div>
              ...
              <div className="swiper-slide">
                <div className="testimonial__item">
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div className="testi-info">
                      <h4>Rachel Foster</h4>
                      <p>Director, Foster Retail Group</p>
                      <div className="star mt-1">
                        <i className="fa-sharp fa-solid fa-star"></i>
                        <i className="fa-sharp fa-solid fa-star"></i>
                        <i className="fa-sharp fa-solid fa-star"></i>
                  ...
                  <p className="mt-30">"Outstanding service from start to finish. The team took time to understand our business needs and delivered a tailored solution. The 24/7 support is invaluable for our retail operations."</p>
                </div>
              </div>
            </div>
          </div>
