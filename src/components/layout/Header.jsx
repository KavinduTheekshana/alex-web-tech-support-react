...
const Header = () => {
  ...
  useEffect(() => {
    // Initialize mobile menu when component mounts
    if (window.jQuery && window.jQuery.fn.meanmenu) {
      window.jQuery('.main-menu nav').meanmenu({
        meanScreenWidth: "991",
    ...
    const handleScroll = () => {
      ...
      if (window.scrollY > 300) {
        ...
        header?.classList.remove('menu-fixed', 'fadeInDown');
      }
    };
    ...
    const openHandler = () => {
      if (targetElement) {
        targetElement.classList.remove('sidebar__hide');
      }
    };

    const closeHandler = () => {
      if (targetElement) {
        targetElement.classList.add('sidebar__hide');
      }
    };
    ...
    return () => {
      ...
      if (openButton) openButton.removeEventListener('click', openHandler);
    ...
    <>
          ...
          <div className="header-top-wrp">
            <ul className="info">
              <li>
                ...
                <a href="mailto:contact@techsupportinc.co.uk" className="ms-1">contact@techsupportinc.co.uk</a>
              </li>
              <li className="ms-4">
                ...
                <a href="tel:+447459425326" className="ms-1">+44 7459 425326</a>
              </li>
            </ul>
        ...
        <div className="container header__container">
          <div className="header__main">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul className="sub-menu">
                      <li><Link to="/outsourced-it-support">Outsourced IT Support</Link></li>
                      <li><Link to="/pricing">Pricing</Link></li>
                      <li><Link to="/microsoft-365">Microsoft 365 & Copilot</Link></li>
                  ...
                  <li><Link to="/areas-we-cover" className={isActive('/areas-we-cover')}>Areas We Cover</Link></li>
            ...
            <div className="d-none d-lg-inline-block">
              <Link to="/contact" className="btn-one">Get A Quote <i className="fa-regular fa-arrow-right-long"></i></Link>
            </div>
      ...
      <div id="targetElement" className="sidebar-area sidebar__hide">
        ...
        <ul className="info pt-40">
          <li><i className="fa-solid primary-color fa-envelope"></i> <a href="mailto:contact@techsupportinc.co.uk">contact@techsupportinc.co.uk</a></li>
          <li className="py-2"><i className="fa-solid primary-color fa-phone-volume"></i> <a href="tel:+447459425326">+44 7459 425 326</a></li>
          <li><i className="fa-solid primary-color fa-location-dot"></i> <a href="#0">United Kingdom</a></li>
        </ul>
